...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.books.update', $book->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-(--color-surface) p-8 rounded-3xl border border-(--color-border) shadow-sm">
            ...
            <div class="space-y-6">
                <div>
                    <label for="title" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Title</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="isbn" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">ISBN</label>
                    ...
                    <div>
                        <label for="page_count" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Page Count</label>
        ...
        <div class="bg-(--color-surface) p-8 rounded-3xl border border-(--color-border) shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <label for="category_id" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Category</label>
                ...
                <div>
                    <label for="author_id" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Author</label>
                ...
                <div>
                    <label for="language" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Language</label>
                ...
                <div>
                    <label for="publication_year" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Pub. Year</label>
        ...
        <div class="bg-(--color-surface) p-8 rounded-3xl border border-(--color-border) shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="lg:col-span-1">
                    <label for="price" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Price ($)</label>
                ...
                <div class="lg:col-span-1">
                    <label for="original_price" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Original ($)</label>
                ...
                <div class="lg:col-span-1">
                    <label for="stock" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Stock Level</label>
                ...
                <div class="lg:col-span-1">
                    <label for="status" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Visibility</label>
        ...
        <div class="bg-(--color-surface) p-8 rounded-3xl border border-(--color-border) shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <label for="cover" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Cover Image</label>
                ...
                <div>
                    <label for="type" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">Product Format</label>
            ...
            <div id="ebook-upload-container" class="mt-8 {{ old('type', $book->type) == 'digital' ? '' : 'hidden' }}">
                <label for="ebook_file" class="block text-xs font-black uppercase tracking-widest text-(--color-muted) mb-2">E-book File (PDF)</label>
